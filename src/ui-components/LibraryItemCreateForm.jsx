...
import { createLibraryItem } from "../graphql/mutations";
...
export default function LibraryItemCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setCompatibleClasses(initialValues.compatibleClasses);
    setCurrentCompatibleClassesValue("");
    setRegion(initialValues.region);
    setStandards(initialValues.standards);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createLibraryItem.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "LibraryItemCreateForm")}
      {...rest}
    >
      <TextField
        label="Title"
