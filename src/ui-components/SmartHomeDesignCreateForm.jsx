...
import { createSmartHomeDesign } from "../graphql/mutations";
const client = generateClient();
export default function SmartHomeDesignCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setSmartHomeId(initialValues.smartHomeId);
    setVersion(initialValues.version);
    setLastModified(initialValues.lastModified);
    setLockedBy(initialValues.lockedBy);
    setLockedAt(initialValues.lockedAt);
    setOntologyVersion(initialValues.ontologyVersion);
    setErrors({});
  };
  const validations = {
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createSmartHomeDesign.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "SmartHomeDesignCreateForm")}
      {...rest}
    >
      <TextField
        label="Smart home id"
